...
Elevation_1_inherit_TYPE_descriptor(asn_TYPE_descriptor_t *td) {
	td->free_struct    = asn_DEF_Uint16.free_struct;
	td->print_struct   = asn_DEF_Uint16.print_struct;
	td->check_constraints = asn_DEF_Uint16.check_constraints;
	td->ber_decoder    = asn_DEF_Uint16.ber_decoder;
	td->der_encoder    = asn_DEF_Uint16.der_encoder;
	td->xer_decoder    = asn_DEF_Uint16.xer_decoder;
	td->xer_encoder    = asn_DEF_Uint16.xer_encoder;
	td->uper_decoder   = asn_DEF_Uint16.uper_decoder;
	td->uper_encoder   = asn_DEF_Uint16.uper_encoder;
	if(!td->per_constraints)
		td->per_constraints = asn_DEF_Uint16.per_constraints;
	td->elements       = asn_DEF_Uint16.elements;
	td->elements_count = asn_DEF_Uint16.elements_count;
	td->specifics      = asn_DEF_Uint16.specifics;
}
...
asn_dec_rval_t
Elevation_decode_uper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
Elevation_encode_uper(asn_TYPE_descriptor_t *td,
...
asn_TYPE_descriptor_t asn_DEF_Elevation = {
	...
	Elevation_decode_uper,
	Elevation_encode_uper,
