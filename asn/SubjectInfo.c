...
static int
memb_subjectName_constraint_1(asn_TYPE_descriptor_t *td, const void *sptr,
...
static asn_per_constraints_t asn_PER_memb_subjectName_constr_3 GCC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 6,  6,  0,  32 }	/* (SIZE(0..32)) */,
	0, 0	/* No PER value map */
};
static asn_TYPE_member_t asn_MBR_SubjectInfo_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct SubjectInfo, subjectName),
		...
		memb_subjectName_constraint_1,
		&asn_PER_memb_subjectName_constr_3,
		0,
		"subjectName"
		},
};
static ber_tlv_tag_t asn_DEF_SubjectInfo_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_SubjectInfo_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* subjectType */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* subjectName */
};
static asn_SEQUENCE_specifics_t asn_SPC_SubjectInfo_specs_1 = {
