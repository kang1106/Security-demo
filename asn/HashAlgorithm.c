...
asn_dec_rval_t
HashAlgorithm_decode_uper(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
HashAlgorithm_encode_uper(asn_TYPE_descriptor_t *td,
...
static asn_per_constraints_t asn_PER_type_HashAlgorithm_constr_1 GCC_NOTUSED = {
	{ APC_CONSTRAINED,	 1,  1,  0,  1 }	/* (0..1) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_INTEGER_enum_map_t asn_MAP_HashAlgorithm_value2enum_1[] = {
	{ 0,	6,	"sgdsm3" },
	{ 1,	6,	"sha256" }
};
static unsigned int asn_MAP_HashAlgorithm_enum2value_1[] = {
	0,	/* sgdsm3(0) */
	1	/* sha256(1) */
};
static asn_INTEGER_specifics_t asn_SPC_HashAlgorithm_specs_1 = {
...
asn_TYPE_descriptor_t asn_DEF_HashAlgorithm = {
	...
	HashAlgorithm_decode_uper,
	HashAlgorithm_encode_uper,
